...
!(function(a, b) {
    ...
    var t = (function(a) {
        ...
        (c = (fa.support = {})), (f = (fa.isXML = function(a) {
            ...
            var b, d = [], e = 0, f = 0;
            if (
                ((l = !c.detectDuplicates), (k = !c.sortStable &&
        ...
        function va(a, b, c, d, e, f) {
            return d && !d[u] && (d = va(d)), e &&
                ...
                if (f) {
                    ...
                    (r = ua(r === g ? r.splice(o, r.length) : r)), e
                        ? e(null, g, r, i)
                        : H.apply(g, r);
            });
        }
        ...
        return (h = (fa.compile = function(a, b) {
            ...
            u), (c.detectDuplicates = !!l), m(), (c.sortDetached = ia(
            function(a) {
        ...
        C = (n.fn.init = function(a, b, c) {
            ...
            if (((c = c || A), "string" == typeof a)) {
                ...
                return (f = d.getElementById(e[2])), f &&
                    ...
                    ((this.length = 1), (this[
                        0
                    ] = f)), (this.context = d), (this.selector = a), this;
            }
            return a.nodeType
    ...
    function R(a, b, c) {
        ...
        if (void 0 === c && 1 === a.nodeType)
            if (
                ((d = "data-" +
                    b.replace(Q, "-$&").toLowerCase()), (c = a.getAttribute(
                    d
                )), "string" == typeof c)
            ) {
                try {
    ...
    n.extend({
        ...
        data: function(a, b) {
            ...
            if (void 0 === a) {
                if (
                    this.length &&
                    ((e = O.get(f)), 1 === f.nodeType &&
                        !N.get(f, "hasDataAttrs"))
                ) {
                    c = g.length;
                    while (c--)
                        g[c] &&
        ...
        for (
            ...
            o++
                ...
                if ("object" === n.type(f))
                    ...
                    (g = g ||
                        l.appendChild(b.createElement("div"))), (h = (Y.exec(
                        f
                    ) || ["", ""])[1]
                        .toLowerCase()), (i = $[h] ||
                        $._default), (g.innerHTML = i[1] +
                        n.htmlPrefilter(f) +
                        i[2]), (k = i[0]);
                    while (k--)
                        g = g.lastChild;
                    n.merge(
                        m,
                        g.childNodes
                    ), (g = l.firstChild), (g.textContent = "");
                } else
                    m.push(b.createTextNode(f));
        (l.textContent = ""), (o = 0);
        while ((f = m[o++])) if (d && n.inArray(f, d) > -1)
                e && e.push(f);
            else if (
                ((j = n.contains(f.ownerDocument, f)), (g = _(
                    l.appendChild(f),
                    "script"
                )), j && aa(g), c)
            ) {
    ...
    (n.event = {
        ...
        add: function(a, b, c, d, e) {
            ...
            if (r) {
                c.handler &&
                    ((f = c), (c = f.handler), (e = f.selector)), c.guid ||
                    ...
                    if (
                        ...
                        for ((d = []), (c = 0); h > c; c++)
                            (f = b[c]), (e = f.selector + " "), void 0 ===
                                ...
                                (d[e] = f.needsContext
                                    ? n(e, this).index(i) > -1
                                    : n.find(e, this, null, [i]).length), d[
                                e
                            ] && d.push(f);
                        d.length && g.push({ elem: i, handlers: d });
                    }
            return h < b.length &&
                g.push({ elem: this, handlers: b.slice(h) }), g;
        },
    ...
    function ua(a, b, c, d) {
        ...
        if (
            ...
            ((e = ca(
                ...
                a,
                d
            )), (g = e.firstChild), 1 === e.childNodes.length && (e = g), g ||
                d)
        ) {
        ...
        function(a, b) {
            n.fn[a] = function(a) {
                for (
                    ...
                    (c = h === f ? this : this.clone(!0)), n(e[h])[b](
                        c
                    ), g.apply(d, c.get());
        ...
        return c ||
            ((c = ya(a, b)), ("none" !== c && c) ||
                ((wa = (wa ||
                    ...
                    .appendTo(b.documentElement)), (b = wa[
                    0
                ].contentDocument), b.write(), b.close(), (c = ya(
                    a,
                    b
                )), wa.detach()), (xa[a] = c)), c;
    }
    ...
    !(function() {
        ...
        if (h.style) {
            (h.style.backgroundClip = "content-box"), (h.cloneNode(
                !0
            ).style.backgroundClip = ""), (l.clearCloneStyle = "content-box" ===
    ...
    function Pa(b, c, e) {
        ...
        if (
            ...
            if (
                ((g = Fa(b, c, h)), (0 > g || null == g) &&
                    (g = b.style[c]), Ba.test(g))
            )
                return g;
            (f = i &&
                (l.boxSizingReliable() || g === b.style[c])), (g = parseFloat(
                g
            ) || 0);
        }
        ...
        style: function(a, b, c, d) {
            if (a && 3 !== a.nodeType && 8 !== a.nodeType && a.style) {
                ...
                return (b = n.cssProps[h] ||
                    (n.cssProps[h] = Ma(h) || h)), (g = n.cssHooks[b] ||
    ...
    (n.Tween = Ra), (Ra.prototype = {
        ...
        run: function(a) {
            ...
            return this.options.duration
                ...
                : (this.pos = (b = a)), (this.now = (this.end - this.start) *
                b +
        ...
        return (d.duration = n.fx.off
            ...
            : "number" == typeof d.duration
                  ...
                  : d.duration in n.fx.speeds
                        ...
                        : n.fx.speeds._default), (null != d.queue &&
            d.queue !== !0) ||
    ...
    n.fn.extend({
        ...
        attrHooks: {
            type: {
                set: function(a, b) {
                    if (
                        !l.radioValue && "radio" === b && n.nodeName(a, "input")
                    ) {
                        var c = a.value;
        ...
        trigger: function(b, c, e, f) {
            ...
            if (
                ...
                while ((h = p[g++]) && !b.isPropagationStopped())
                    (b.type = g > 1 ? j : o.bindType || q), (m = (N.get(
                        h,
                        "events"
                    ) || {})[b.type] && N.get(h, "handle")), m &&
                ...
                return (b.type = q), f ||
                    ...
                    (l &&
                        ...
                        !n.isWindow(e) &&
                        ((i = e[l]), i &&
                            (e[l] = null), (n.event.triggered = q), e[
                            q
                        ](), (n.event.triggered = void 0), i &&
                            (e[l] = i))), b.result;
            }
        },
        simulate: function(a, b, c) {
            var d = n.extend(new n.Event(), c, { type: a, isSimulated: !0 });
            n.event.trigger(d, null, b), d.isDefaultPrevented() &&
                c.preventDefault();
        }
    }), n.fn.extend({
        ...
        n.each({ focus: "focusin", blur: "focusout" }, function(a, b) {
            ...
            n.event.special[b] = {
                setup: function() {
                    ...
                    e || d.addEventListener(a, c, !0), N.access(
                        d,
                        b,
                        (e || 0) + 1
                    );
    ...
    n.extend({
        ...
        ajax: function(b, c) {
            ...
            if (
                ((q.promise(
                    x
                ).complete = r.add), (x.success = x.done), (x.error = x.fail), (m.url = ((b ||
                    m.url ||
                    jb.href) + "")
                    .replace(mb, "")
                    .replace(rb, jb.protocol + "//")), (m.type = c.method ||
                    c.type ||
                    m.method ||
                    m.type), (m.dataTypes = n
                    .trim(m.dataType || "*")
                    .toLowerCase()
            ...
            if (
                (m.data &&
                    ...
                    (m.data = n.param(m.data, m.traditional)), xb(
                    sb,
                    m,
                    c,
                    x
            ...
            function z(b, c, d, h) {
                ...
                2 !== v &&
                    ((v = 2), i && a.clearTimeout(i), (e = void 0), (g = h ||
                        ""), (x.readyState = b > 0 ? 4 : 0), (j = (b >= 200 &&
                        300 > b) ||
                        304 === b), d && (u = zb(m, x, d)), (u = Ab(
                        m,
                        u,
                        x,
                        j
                        ...
                        : ((t = y), (!b && y) ||
                              ((y = "error"), 0 > b &&
                                  (b = 0))), (x.status = b), (x.statusText = (c ||
                        y) + ""), j
                        ? q.resolveWith(o, [l, y, x])
                        : q.rejectWith(o, [x, y, t]), x.statusCode(
                        s
                    ), (s = void 0), k &&
                        ...
                        (p.trigger("ajaxComplete", [x, m]), --n.active ||
    ...
    (n.param = function(a, b) {
        ...
        if (
            (void 0 === b &&
                (b = n.ajaxSettings && n.ajaxSettings.traditional), n.isArray(
                a
            ) ||
    ...
    n.ajaxSetup({
        ...
        return e
            ? [b.createElement(e[1])]
            : ((e = ca([a], b, f)), f && f.length && n(f).remove(), n.merge(
                  [],
                  e.childNodes
              ));
    });
